...
packages <- c("knitr", "stats", "dplyr","rmarkdown","tibble", "data.table","kableExtra","tidyr", "ggridges", "ggplot2", "anytime", "stringr", "patchwork")
...
#packages
 packages <- c("tidyr","tidyverse","dplyr", "knitr", "rmarkdown")
...
# 폴더 list / 폴더 설정
fdr.name <- list.files(pattern="N-3")
fdr <- 27 #"N-3_RJ-110V"
